...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        {
            _context.Add(entity); //saved in memory
        }
        ...
        public async Task<PagedList<User>> GetUsers(UserParams userParams)
        {
            ...
            {
                var userLikeers = await GetUserLikes(userParams.UserId, userParams.Likers);
                users = users.Where(u => userLikeers.Contains(u.Id));
            }
